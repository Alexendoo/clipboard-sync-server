...
// DevicesG retrieves all the device's devices.
func (o *User) DevicesG(mods ...qm.QueryMod) deviceQuery {
	return o.Devices(boil.GetDB(), mods...)
}

// Devices retrieves all the device's devices with an executor.
func (o *User) Devices(exec boil.Executor, mods ...qm.QueryMod) deviceQuery {
	...
	query := Devices(exec, queryMods...)
	queries.SetFrom(query.Query, "\"devices\" as \"a\"")
	return query
}

// LoadDevices allows an eager lookup of values, cached into the
// loaded structs of the objects.
func (userL) LoadDevices(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
	...
	query := fmt.Sprintf(
		"select * from \"devices\" where \"user_id\" in (%s)",
...
// AddDevicesG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Devices.
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddDevicesG(insert bool, related ...*Device) error {
	return o.AddDevices(boil.GetDB(), insert, related...)
}

// AddDevicesP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Devices.
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddDevicesP(exec boil.Executor, insert bool, related ...*Device) {
	if err := o.AddDevices(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddDevicesGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.Devices.
// Sets related.R.User appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddDevicesGP(insert bool, related ...*Device) {
	if err := o.AddDevices(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Appends related to o.R.Devices.
// Sets related.R.User appropriately.
func (o *User) AddDevices(exec boil.Executor, insert bool, related ...*Device) error {
	var err error
